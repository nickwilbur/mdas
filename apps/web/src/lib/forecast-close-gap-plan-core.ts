 ...
 *
 * Prompt construction lives in the server-only wrapper; this module
 * holds the JSON/fence parsing and field normalization so vitest can
 * lock down Glean reply shapes without mocking the Glean client.
 */
import {
...
/**
 * Strict parser + validator for one account's Glean reply. Drops the
